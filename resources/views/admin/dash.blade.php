...
<html class="fixed sidebar-left-xs">
	<head>
		...
		<title>CLEAR_RISK Dashboard</title>
	...
	<body>
		<section class="body">
			...
			<!-- start: header -->
			<header class="header">
				<div class="logo-container p-0 m-0">
					<a href="../1.7.0]" class="logo">
						<img src="{{ asset('assets/images/ClearRisk_BlackLOGO.png') }}" width="200" height="65" alt="Porto Admin" class="p-0" />
					</a>
				...
				<div class="header-right">
					...
					<form action="pages-search-results.html" class="search nav-form">
						<div class="input-group input-search p-3">
							<input style="width: 200px; " type="text" class="form-control" name="q" id="q" placeholder="Search...">
									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="assets/images/!sample-user.jpg" alt="irm.Somnath" class="img-circle" />
												</figure>
												<span class="title">irm.Somnath</span>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="{{ asset('assets/images/ClearRisk_BlackLOGO.png') }}" alt="Joseph Doe" class="img-circle" data-lock-picture="assets/images/!logged-user.jpg" />
							</figure>
										...
										<div class="col-lg-4 text-center">
											...
											<div class="liquid-meter-wrapper liquid-meter-sm mt-lg">
												...
												<div class="liquid-meter-selector" id="meterSalesSel">
													<a href="#" data-val="85" class="active">Monthly Goal</a>
													<a href="#" data-val="50">Annual Goal</a>
												</div>
											</div>
										</div>
									</div>
										...
										<header class="panel-heading bg-primary">
											...
											<div class="widget-profile-info">
												<div class="profile-picture">
													<img src="{{ asset('assets/images/ClearRisk_BlackLOGO.png') }}">
												</div>
												<div class="profile-info">
													<h4 class="name text-weight-semibold">irm.Somnath</h4>
